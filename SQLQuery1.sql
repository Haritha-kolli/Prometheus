...
CREATE PROCEDURE  [haritha].[SPX_Update_150913_Course]
...
AS
	update haritha.Course set CourseName=@Name,
	StartDate=@start,EndDate=@End where CourseID=@id

RETURN 0

--Adding new COurse
CREATE PROCEDURE  [haritha].[SPX_Add_150913_Course]
...
AS
	insert into haritha.Course(CourseName,StartDate,EndDate) values (@Name,@start,@End)
